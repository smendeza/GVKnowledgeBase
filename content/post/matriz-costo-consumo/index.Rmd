...
# ¿Qué es una matriz costo consumo y para qué nos sirve?
...
# Evaluando el MEF de depuración de portafolio
  ...
  * Excluir nuevas compras de este producto, debido a que la decisión de compra fue tomada previo a que iniciamos el proyecto.
    * Utilizar como tasa de descuento el costo de los préstamos actuales de la empresa
  * Calcular los montos de inventario al final de cada mes y volver a calcular el costo financiero
  * Sacar la diferencia entre la línea base y el valor actual del inventario
...
Hay que destacar que también se establece un objetivo mensual y global para esta iniciativa, es algo recomendable de realizar para ir midiendo la efectividad de nuestros esfuerzos y realizar acciones puntuales en caso de necesitar correciones.
...
En el caso de la categoría de consumo B, podríamos acortar las coberturas, con el objetivo de no perder costos de oportunidad en las ítems de consumo A. Además, tenemos que resaltar que tenemos coberturas muy elevadas en la categoría de consumo C, por lo que debemos de realizar esfuerzos por disminuir las mismas y evitar mas compras de estos productos. Esto nos ayudará a **eficientar** la administración del dinero invertido en inventario y hacerlo más productivo.
