...
## ABC de Venta
Para esta variable, lo recomendable es usar daa histórica de los últimos 12 meses (U12m), ya sea totalizada o en base al promedio mensual de venta(recomendable). Una vez realizado el [análisis ABC](http://127.0.0.1:3200/post/clasificacion-abc-pareto/) procedemos a realizar el mismo para la siguiente variable.
...
Con la información a la mano, podemos calcular las siguientes medidas, que nos pueden servir para ampliar el análisis y tener mayor contexto para la toma de decisiones:
  ...
  * Cobertura(meses): Inventario actual/Venta promedio U12M
...
Para una toma de decisiones más informada para la administración del inventario, podemos considerar ampliar al análisis tomando en cuenta los [coeficientes de variación](Análisis ABC-xyz). Adicionalmente, podemos seguir ampliando el análisis tomando en cuenta información de contexto comercial.
