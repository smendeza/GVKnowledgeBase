...
![Costo Consumo](/post/matriz-costo-consumo/index_files/COSTO CONSUMO.png)
...
Para una toma de decisiones más informada para la administración del inventario, podemos considerar ampliar al análisis tomando en cuenta los [coeficientes de variación](https://cocky-dijkstra-cf91ca.netlify.com/post/coeficiente-de-variacion/). Adicionalmente, podemos seguir ampliando el análisis tomando en cuenta información de contexto comercial.
